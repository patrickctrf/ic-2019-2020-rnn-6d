...
da TUM. Mto chata mds
    ...
    :param imu_data: Array-like with samples from IMU.
    :param ground_truth: Array-like with samples from ground truth.
...
temporal e convete-lo para arquivos numpy, de forma que a classe que criamos
